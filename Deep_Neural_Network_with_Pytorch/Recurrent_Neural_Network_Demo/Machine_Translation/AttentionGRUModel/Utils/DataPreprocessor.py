...
class trainComponentsGenerator():
    ...
    @staticmethod
    def minibacthGenerator(batchSize, root, shuffle = True, train = True):
        # Getting the data.
    ...
    @staticmethod
    def trainComponentsGenerator(batchSize, vocabSize, root, shuffle = True, train = True):
        # Getting the minibatches.
        minibatches = trainComponentsGenerator.minibacthGenerator(batchSize, root, shuffle, train)
        # Getting the tokenized data.
